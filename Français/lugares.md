...
- `Amphithéâtre` Anfiteatro
    - `Amphi` Abreviação
- `Boucherie` Açougue 🚺
- `Université` Universidade (pública)
- `Grande école` Universidade (particular)
- `Faculté` Faculdade
    - `Fac` Abreviação
- `Cité universitaire` Residência universitária
    - `Cité U` Abreviação
- `Bibliothéque universitaire` Biblioteca universitária
    - `BU` Abreviação
