...
- `Pronome` (Pronoun): Substituto genérico de um substantivo.
    ...
    - `Honorífico` ou `de Tratamento`: Respeitoso, é utilizado comumente em situações formais. Ex.: "senhor"; "Vossa Magnificência". Ex. (Japonês): "さま"; "様".
...
- `Infinitivo`: Forma não flexionada do verbo. Geralmente a forma verbal encontrada nos dicionários de grande parte das línguas. Pode ser usado como substantivo, adjetivo ou advérbio.
