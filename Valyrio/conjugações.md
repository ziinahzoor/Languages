...
-   Para raízes terminadas em vogais o primeiro `i` da conjungação substitui a vogal e se transforma conforme ela:
    -   `-a`, `-o` → `-ē`
    -   `-e`, `-i`, `-u` → `-ī`
...
-   Para raízes terminadas em vogais o primeiro `i` da conjungação substitui a vogal e se transforma conforme ela:
    -   `-a`, `-o` → `-ē`
    -   `-e`, `-i`, `-u` → `-ī`
-   Para o verbo `sagon`, a raíz no futuro é `kes-`
...
| Número                  | Verbos -agon | Verbos -gon |
| ----------------------- | ------------ | ----------- |
| Nyke/Ziry/Ūja           | -aks         | -`◆`ks      |
| Ao/Jeme                 | -āks         | -`❖`ks      |
| Īlon/Pōnta              | -aksi        | -`◆`ksi     |
| Īlon/Pōnta (Subjuntivo) | -oksy        | -`◆`ksy     |

> [!IMPORTANT]
> ◆ Vogal-tema.
> ❖ Vogal-tema alongada

-   Os tempos seguem conforme a voz ativa, porém com a terminação na voz passiva.
