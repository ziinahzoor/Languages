...
- `られる` para verbos ichidan e honoríficos.
...
<h3 id="var_negativa-enfatica">Forma negativa enfática (はしない)</h3>

- Enfatiza que a ação não é/não será feita.
- Também pode ser encontrada como `やしない`, geralmente indicando ainda mais ênfase e uma nuance como `de jeito nenhum`.
    - As terminações `り` e `き` costumam se fundir na construção como `りゃ` e `きゃ`.

<h3 id="var_negativa-enfatica-excludente">Forma negativa enfática excludente (もしない)</h3>

- Enfatiza que a ação nem mesmo é realizada. Ex.: `食べもしないよ` "Você nem mesmo vai comer".
...
**Faz parte da base `連用形`**.

**As mudanças eufônicas estão listadas abaixo:**

<table>
    <thead>
        <tr>
        <th><ruby>音<rt>おん</rt>便<rt>びん</rt></ruby></th>
        <th>Final</th>
        <th>Mnemônico</th>
        <th>Forma た</th>
        <th>Forma て</th>
    ...
    <tr>
        <td>イ<ruby>音<rt>おん</rt>便<rt>びん</rt></ruby></td>
        <td>く・ぐ</td>
        <td>Quite/Guide</td>
        <td>いた・いだ</td>
        <td>いて・いで</td>
    ...
    <tr>
        <td><ruby>撥<rt>はつ</rt>音<rt>おん</rt>便<rt>びん</rt></ruby></td>
        <td>ぬ・ぶ・む</td>
        <td>New Boom</td>
        <td>んだ</td>
        <td>んで</td>
    ...
    <tr>
        <td><ruby>促<rt>そく</rt>音<rt>おん</rt>便<rt>びん</rt></ruby></td>
        <td>う・つ・る</td>
        <td>O tiro</td>
        <td>った</td>
        <td>って</td>
